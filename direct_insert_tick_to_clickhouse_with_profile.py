...
def get_secret(secret_name, region_name="us-east-1", profile_name="clickhouse"):
    """
...
def download_and_insert_tick_data(ticker, start_date, end_date, host, secret_name, region_name="us-east-1", profile_name="clickhouse", port=9000, database='tick_data_database_3'):
    """
...
if __name__ == "__main__":
    ...
    PROFILE_NAME = "clickhouse"  # AWS profile name to use
